# 📁 ArgusML Documentation & Architecture Bundle

Welcome to the consolidated documentation and engineering specification directory for **ArgusML**. Everything you need for system architecture, DSA proofs, presentation slides, and viva preparation is organized in this single directory:

---

## 📑 Consolidated Documents in this Directory
...
* **Master Technical Specification:** [`BRAIN.md`](../BRAIN.md)
* **Persistent Agent Memory:** [`GEMINI.md`](../GEMINI.md)
